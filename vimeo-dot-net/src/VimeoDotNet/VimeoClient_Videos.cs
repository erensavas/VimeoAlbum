...
namespace VimeoDotNet
{
    public partial class VimeoClient
    {
        ...
        /// <inheritdoc />
        public async Task<Paginated<Video>> GetVideosAsync( int? page, int? perPage, string query = null,
            string[] fields = null)
        {
            try
            {
                var request = GenerateVideosRequest( page: page, perPage: perPage, query: query,
                    fields: fields);
        ...
        public async Task<Paginated<VideoAllowedDomain>> GetAllowedDomains(int? page, int? perPage, long videoId)
        {
            try
            {
                var request = GenerateAllowedDomainsRequest(page: page, perPage: perPage, clipId: videoId
                   );
                var response = await request.ExecuteRequestAsync<Paginated<VideoAllowedDomain>>().ConfigureAwait(false);
                UpdateRateLimit(response);
                CheckStatusCodeError(response, "Error retrieving video allowed urls.", HttpStatusCode.NotFound);

                if (response.StatusCode == HttpStatusCode.NotFound)
                {
                    return new Paginated<VideoAllowedDomain>
                    {
                        Data = new List<VideoAllowedDomain>(),
                        Page = 0,
                        Total = 0
                    };
                }
        ...
        public async Task<Paginated<Video>> GetAlbumVideosAsync(UserId userId, long albumId, int? page = null,
            int? perPage = null, string sort = null, string direction = null,string query=null, string[] fields = null)
        {
            try
            {
                var request = GenerateAlbumVideosRequest(albumId,query:query, page: page, perPage: perPage, sort: sort,
        ...
        /// <inheritdoc />
        public async Task UpdateVideoAllowedDomainAsync(long? clipId, string domain,string method)
        {
            try
            {
                var request = GenerateVideoAllowedDomainPatchRequest(clipId, domain,method);
                var response = await request.ExecuteRequestAsync();
                UpdateRateLimit(response);
        ...
        private IApiRequest GenerateVideosRequest( long? clipId = null, int? page = null,
            int? perPage = null, string query = null, string[] fields = null)
        {
            ...
            {
                request.Query.Add("weak_search", "true");
        ...
        private IApiRequest GenerateAllowedDomainsRequest(long? clipId = null, int? page = null,
           int? perPage = null)
        {
            ThrowIfUnauthorized();
            ...
            endpoint = Endpoints.VideoAllowedDomains;
            request.Method = HttpMethod.Get;
            request.Path = endpoint;
        ...
        private IApiRequest GenerateAlbumVideosRequest(long albumId, long? userId = null, long? clipId = null,string query=null,
            int? page = null, int? perPage = null, string sort = null, string direction = null, string[] fields = null)
        {
            ...
            if (fields != null)
            {
                ...
                request.Query.Add("fields", String.Join(", ", fields));
            }
        ...
        private IApiRequest GenerateVideoAllowedDomainPatchRequest(long? clipId, string domain,string method)
        {
            ThrowIfUnauthorized();
