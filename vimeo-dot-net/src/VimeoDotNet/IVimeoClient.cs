...
namespace VimeoDotNet
{
    ...
    public interface IVimeoClient
    {
        ...
        Task<Paginated<Video>> GetVideosAsync( int? page = null, int? perPage = null,
        ...
        /// Get videos by UserId and query and page parameters asynchronously
        /// </summary>
        /// <param name="videoId">UserId</param>
        /// <param name="perPage">Number of items to show on each page. Max 50</param>
        /// <param name="page">The page number to show</param>
        /// <returns>Paginated VideoAllowedDomains</returns>

        Task<Paginated<VideoAllowedDomain>> GetAllowedDomains(int? page, int? perPage, long videoId);
        ...
        Task<Paginated<Video>> GetAlbumVideosAsync(UserId userId, long albumId, int? page = null, int? perPage = null,
            string sort = null, string direction = null,string query=null, string[] fields = null);
        ...
        Task UpdateVideoAllowedDomainAsync(long? clipId, string domain,string method);
        ...
        Task<bool> AddToAlbumAsync( long albumId, AddToAlbumParameters parameters = null);
        ...
        ///  
        /// <param name="albumId">AlbumId</param>
        /// <param name="videoId">ClipId</param>
